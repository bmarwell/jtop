...
public class in6_addr {
    ...
    public static class __u6_addr {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
                        MemoryLayout.sequenceLayout(16, proc_info_h.C_CHAR).withName("__u6_addr8"),
                        MemoryLayout.sequenceLayout(8, proc_info_h.C_SHORT).withName("__u6_addr16"),
                        MemoryLayout.sequenceLayout(4, proc_info_h.C_INT).withName("__u6_addr32"))
                .withName("$anon$153:2");
        ...
        private static final SequenceLayout __u6_addr8$LAYOUT =
                (SequenceLayout) $LAYOUT.select(groupElement("__u6_addr8"));
        ...
        private static final SequenceLayout __u6_addr16$LAYOUT =
                (SequenceLayout) $LAYOUT.select(groupElement("__u6_addr16"));
        ...
        private static final SequenceLayout __u6_addr32$LAYOUT =
                (SequenceLayout) $LAYOUT.select(groupElement("__u6_addr32"));
